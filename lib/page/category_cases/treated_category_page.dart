...
class TreatedCategoryPage extends StatelessWidget {
  final Cases infoTreated;
  final String date;

  TreatedCategoryPage({Key key, this.infoTreated, this.date}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            DataTable(
              ...
              rows: infoTreated.condition.listData
            ...
            DataTable(
              ...
              rows: infoTreated.gender.listData
                  .map((index) => DataRow(cells: [
                DataCell(
                    Text(index.key)
                ),
            ...
            DataTable(
              ...
              rows: infoTreated.ageGroup.listData
                  .map((index) => DataRow(cells: [
                DataCell(
                    Text(index.key)
                ),
            ...
            DataTable(
              ...
              rows: infoTreated.symptoms.listData
                  .map((index) => DataRow(cells: [
                DataCell(
                    Text(index.key)
                ),
